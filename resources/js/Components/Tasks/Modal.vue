    ...
    <div class="card flex justify-center">
        <Dialog v-model:visible="visible" modal :header="header" :style="{ width: '25rem' }">
            ...
            <div class="flex justify-center gap-2">
                <Button class="w-[100px] !text-white" type="button" :label="buttonText" @click="submit"
...
const submit = () => {
    ...
    if (action.value === 'delete') form.delete(`tasks/${taskIdToDelete.value}`);
...
watch([task, action], () => {
    ...
    */
    if (action.value === 'create' || action.value === 'delete') {
        form.title = ''
        form.description = ''
        form.category = ''
        form.finished = false
